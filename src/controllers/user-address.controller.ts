...
export class UserAddressController {
  static async createUserAddress(req: Request, res: Response) {
    try {
      ...
      const phone_number = new PhoneNumber(createUserAddressDto.phone_number);
  ...
  static async updateUserAddressById(req: Request, res: Response) {
    try {
      ...
      updateUserAddressDto.phone_number ? new PhoneNumber(updateUserAddressDto.phone_number) : null;
